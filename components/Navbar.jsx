      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-20 items-center justify-between">
          ...
          {/* <!-- Right Side Menu (Logged Out) --> 
            ***keep in mind 'providers' only has ONE object full of data
            so the map converts that ONE object's values into an array
            so that the ONE <button/> can pull those values. But only ONE
            button results from the map method :)
          */}
          {
              !session && (
